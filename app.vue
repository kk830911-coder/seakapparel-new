  ...
  <div class="bg-gray-50 min-h-screen flex flex-col font-sans">
    ...
    <footer class="mt-12 py-10 text-gray-300" style="background-color:#1a1a24;">
      <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="border-t border-gray-700 pt-6 text-sm opacity-80">
          <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <p>©2026 seakapparel | All Rights Reserved</p>
            <div>
              <NuxtLink to="/privacy-policy" class="text-gray-400 hover:text-white transition duration-300 hover:underline underline-offset-4">Privacy Policy</NuxtLink>
            </div>
          </div>
        </div>
      </div>
